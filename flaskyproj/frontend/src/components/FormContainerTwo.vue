<template>
  <div class="form-container-two">
    ...
    <div class="white-container">
      <div class="heading"><h3>Data Identification Information</h3></div>
      ...
      <div class="bottom">
        <div class="data-type">
          ...
          <select name="data-type" id="dataType" v-model="dataType">
        ...
        <div class="Edition">
          ...
          <select name="edition" id="edition" v-model="edition">
...
@media only screen and (max-width: 480px) {
  ...
  .nom,.themelabel,.keyword-heading,.ac-cs,.use-cs,.heading-purpose{
    font-size: 15px;
    right: 100px;
  }
  .nom{
...
#tick-ac-cs,#tick-purpose,#tick-use-cs{
  right: 34px;
}
