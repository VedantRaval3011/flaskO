<template>
  <div class="form-container-extra">
    ...
    <div class="resampling">
      <label for="resampling" class="resamplingText">resampling</label>
      <select name="compression" id="resampling" v-model="resampling">
    ...
    <div class="interleave">
      <label for="interleave" class="interleaveText">Interleave</label>
      <select name="interleave" id="interleave" v-model="interleave">
    ...
    <div class="projection">
      ...
      <div class="inputs">
        ...
        <button v-if="!showProjection3 && showProjection2" @click="addInput2">
          Add
        </button>
        <div class="third">
          <input
